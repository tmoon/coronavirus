...
parser.add_argument('--infile', type=str, help='input file name. the format should be <country>_<last date of observation>.csv', 
                    nargs='?', default='germany_april_27.csv')
...
parser.add_argument('--cutoff', type=int, help='threshold for number of new positive cases to be detected on a single day. estimation begins from that day.', nargs='?', default=25)
...
country = pd.read_csv(filedir+'/'+filename,
                     usecols=[0, 1],
                     parse_dates=[0],
                     index_col=[0],
                     names=['date', 'positive'],
